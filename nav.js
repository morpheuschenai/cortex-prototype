// Cortex Prototype — shared nav injector
// Auto-inject hamburger + drawer on every page
(function () {
  const currentPath = window.location.pathname.split('/').pop() || 'index.html';

  const mainFlow = [
    { num: '01', file: '01-landing.html', label: 'Landing · 輸入品牌網址' },
    { num: '02', file: '02-media-fit.html', label: 'Media Fit Preview' },
    { num: '03', file: '03-chat.html', label: 'ChatBot 5 題訪談' },
    { num: '04', file: '04-full-analysis.html', label: 'Full Analysis + Tier' },
    { num: '08', file: '08-timeline.html', label: 'Timeline Review Status' },
    { num: '09', file: '09-parallel-actions.html', label: 'Parallel Actions' },
    { num: '10', file: '10-forecast.html', label: 'Simulated Forecast' },
    { num: '11', file: '11-first-mover.html', label: 'First-mover 品牌權益' }
  ];

  const exceptions = [
    { num: '06', file: '06-confidence.html', label: 'Sorted Confidence List' },
    { num: '07', file: '07-correction.html', label: 'Correction Feedback' },
    { num: '12', file: '12-zero-match.html', label: 'Zero-match Waitlist' }
  ];
